...
class DeviceAdapter(context: Context?, devices: ArrayList<Device>) :
    ...
    override fun getView(position: Int, convertView: View, parent: ViewGroup): View {
        ...
        val driverName: String = devices[position].root!!
        val file: File = devices[position].file!!
        ...
        permission.append("]")
        holder.device!!.text =
            String.format("%s [%s] (%s)  %s", deviceName, driverName, path, permission)
        return convertView
    }
